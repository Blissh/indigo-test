...
namespace ProductsAPI.API
{
    public static class ProductEndpoints
    {
        ...
        {
            endpoints.MapGet("/products/{id}", [AllowAnonymous] async (HttpContext context, IProductService productService, int id) =>
            {
            ...
            endpoints.MapGet("/products", [AllowAnonymous] async (HttpContext context, IProductService productService) =>
            {
            ...
            endpoints.MapPost("/products", [AllowAnonymous] async (HttpContext context, IProductService productService, CreateProductRequest request) =>
            {
            ...
            endpoints.MapPut("/products/{id}", [AllowAnonymous] async (HttpContext context, IProductService productService, int id, UpdateProductRequest request) =>
            {
            ...
            endpoints.MapDelete("/products/{id}", [AllowAnonymous] async (HttpContext context, IProductService productService, int id) =>
            {
